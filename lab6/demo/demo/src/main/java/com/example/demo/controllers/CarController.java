...
public ResponseEntity addAccident(@PathVariable("id") int id, @RequestBody Accident accident)
    {
    ...
    public ResponseEntity getAccidentById(@PathVariable("id") int carId,@PathVariable("accident_id") int accidentId) {
    ...
    public ResponseEntity deleteAccident(@PathVariable("id") int carId,@PathVariable("accident_id") int accidentId){
    AccidentDto accident = carService.deleteAccident(carId, accidentId);
    if(accident == null) return ResponseEntity.notFound().build();
    return ResponseEntity.noContent().build();
    }
    @PutMapping("{id}/accidents/{accident_id}")
    public ResponseEntity updateAccident(@PathVariable("id") int carId, @PathVariable("accident_id") int accidentId, @RequestBody AccidentDto accident){
